...
<html>
  ...
  <body>
    ...
    <div>
      ...
      <ul>
        {% if user.is_authenticated %} {% url 'account_email' as email_url_ %}
        {% if email_url_ %}
        <li>
          <a href="{{ email_url_ }}">{% trans "Change Email" %}</a>
        </li>
        {% endif %} {% url 'account_change_password' as change_password_url_ %}
        {% if change_password_url_ %}
        <li>
          <a href="{{ change_password_url_ }}">{% trans "Change Password" %}</a>
        </li>
        {% endif %} {% url 'socialaccount_connections' as connections_url_ %} {%
        if connections_url_ %}
        <li>
        ...
        {% endif %} {% url 'usersessions_list' as usersessions_list_url_ %} {%
        ...
        {% endif %} {% else %} {% url 'account_login' as login_url_ %} {% if
        login_url_ %}
        <li>
